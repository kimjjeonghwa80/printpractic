<?php
	...
	$insert_Qry = "INSERT INTO texts(text_name, text_thumbnail, text_json, cat_id) VALUES ('".$_POST['filename']."', '".$_POST['pngimageData']."', ".json_encode($_POST['jsonData']).", '".$_POST['category']."')";
