<?php
	...
	if(mysql_num_rows($runQuery) > 0){
	 while($row = mysql_fetch_array($runQuery)){ 
			$bgpath = str_replace("C:\\fakepath\\", "",$row['bg_path']);
	 	?>
	   <div class="col-lg-6 col-md-8 col-xs-12 thumb" id="<?php  echo $row['id']; ?>" style="padding:5px;">
		  <a class="thumbnail" href="#" style="margin-bottom: 0;">
			<img class="bgImage img-responsive" data-imgsrc="<?php  echo $bgpath; ?>" src="<?php  echo $bgpath; ?>" alt="" style="height:125px; width:200px; ">
