...
(function() {
	...
	function UploadFile(file) {
		...
		if (xhr.upload && (file.type == "image/jpeg" || file.type == "image/jpg" || file.type == "image/png" || file.type == "image/gif" || file.type =="image/svg+xml") && file.size <= $id("MAX_FILE_SIZE").value) {
