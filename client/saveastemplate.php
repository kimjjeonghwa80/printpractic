<?php
	...
	$insert_Qry = "INSERT INTO user_templates (userid, template_name, canvas_thumbnail, canvas_json, created_date, modified_date, cat_id) VALUES ('$userid', '".$_POST['filename']."', '', '', now(), now(), '".$_POST['chkdatcatid']."')";
